...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Replace Receive From Supplier</li>
    </ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i><b>
            Replace Receive From Supplier</b></div>
        <div class="card-body">
                ...
                <form action="" method="post" name="add_damage" id="damage_entry_form" onsubmit="showFormIsProcessing('damage_entry_form');">
                    <div class="row" id="div1" style="">
                        <div class="col-xs-2">
                            <div class="form-group">
                                <label> Date</label>
                                <input type="text" autocomplete="off" name="rrs_date" id="rrs_date" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="form-group">
								...
								<?php if($_SESSION['logged']['user_type'] == 'whm')
									{
										...
										$rrsCode= 'SR-'.$short_name;
									} else{
										$rrsCode= 'SR-CW';
									}
								?>
                                <input type="text" name="rrs_id" id="rrs_id" class="form-control" value="<?php echo getDefaultCategoryCodeByWarehouse('inv_replacerecivesupplier', 'rrs_id', '03d', '001', $rrsCode) ?>">
                                <input type="hidden" name="damage_no" id="damage_no" value="<?php echo getDefaultCategoryCodeByWarehouse('inv_replacerecivesupplier', 'rrs_id', '03d', '001', $rrsCode) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <div class="modal-footer">
                                    <input type="submit" name="Replacereceivefromsupplier_submit" id="Replacereceivefromsupplier_submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="Save" />
                                </div>    
                            </div>
                        </div>
                    </div>
