                        ...
                        <div class="col-sm-4">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="discount_amount" id="discount" value="<?php echo $damarageSaleData->discount_amount; ?>" /></td>
                                </tr>


                                <tr>
                                    <td>Net Sale Amount</td>
                                    <td><input type="text" class="form-control" name="netsale_amount" id="netsale" value="<?php echo $damarageSaleData->netsale_amount; ?>" readonly /></td>
                                </tr>
