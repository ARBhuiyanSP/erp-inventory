...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
			...
			<?php
				$sqld = "select * from `inv_replacerecivesupplier` where `rrs_id`='$rrs_id'";
			...
			<div class="card-body" id="printableArea">
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="row">
							...
							<div class="col-sm-6">
								<table class="table table-bordered">
									<tr>
										<th>Replace No:</th>
										<td><?php echo $rrs_id; ?></td>
									</tr>
									<tr>
										<th>Date:</th>
										<td><?php
										echo $rowd['rrs_date']; ?></td>
									</tr>
						...
						<center><button class="btn btn-block btn-secondary challan">REPLACE RECEIVE TO SUPPLIER</button></center>
						...
						<!-- id="material_receive_list = FOR SEARCH AND PAGE COUNT VIEW SHOW -->
							...
							<tbody id="material_receive_list_body">
								...
								$sql = "select * from `inv_replacerecivesupplierdetails` where `rrs_id`='$rrs_id'";
						...
						<tr>
									...
									<td>	
										<?php 
										$sql2 			= "SELECT sum(return_qty) FROM  `inv_replacerecivesupplierdetails` where `rrs_id`='$rrs_id'";
