                            ...
                            <div class="form-group">
								...
								<?php
									...
									if(isset($rowedit['voucherid']) && !empty($rowedit['voucherid'])){
										...
										$voucherid 	=	getDefaultCategoryCode('party_payment', 'voucherid', '03d', '001', 'VID-');
									}
                                   ?>
...
<div class="col-xs-1">
						...
						<div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <select name="paymenttype" id="paymenttype" value="<?php if (isset($rowedit['paymenttype']) && $rowedit['paymenttype'] != '') { echo $rowedit['paymenttype']; }?>" class="form-control">
