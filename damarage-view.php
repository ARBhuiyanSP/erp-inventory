...
<?php
	$sqld = "select * from `inv_damaragesale` where `ds_id`='$ds_id'";
			...
			<div class="card-body" id="printableArea">
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<center><h3 >DAMARAGE INVOICE</h3></center>
						...
						<table class="table table-bordered" id="material_receive_list"> 
							...
							<tbody id="material_receive_list_body">
								...
								$sql = "select * from `inv_damaragedetailsale` where `ds_id`='$ds_id'";
								...
								<tr>
									...
									<td>
										<?php 
										$sql2 = "SELECT totalamount FROM  `inv_damaragesale` where `ds_id`='$ds_id'";
									...
									<td>
										<?php 
										$sql2 = "SELECT paidamount FROM  `inv_damaragesale` where `ds_id`='$ds_id'";
										$result2 = mysqli_query($conn, $sql2);
										for($i=0; $row2 = mysqli_fetch_array($result2); $i++){
								...
								<tr>
									...
									<td>
										<?php 
										$sql2 = "SELECT Dueamount FROM  `inv_damaragesale` where `ds_id`='$ds_id'";
										$result2 = mysqli_query($conn, $sql2);
										for($i=0; $row2 = mysqli_fetch_array($result2); $i++){
						...
						<div class="row" style="text-align:center">
							...
							<div class="col-sm-2">
								<?php $queryedit	= "SELECT `approval_status` FROM `inv_damaragesale` WHERE `ds_id`='$ds_id'";
