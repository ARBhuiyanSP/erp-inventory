...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    ...
    $data               = getReplaceRecSupplierDataDetailsById($edit_id); // this function damage_process.php file ar vitor
                ...
                <form action="" method="post" name="update_receive" id="update_receive" enctype="multipart/form-data">
                    <div class="row" id="div1" style="">
                        <div class="col-xs-2">
                            <div class="form-group">
                                <label> Date</label>
                                <input type="text" autocomplete="off" name="rrs_date" id="rrs_date" class="form-control datepicker" value="<?php echo date('Y-m-d', strtotime($replaceRecData->rrs_date)); ?>">
					   ...
					   <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="rrs_id" id="rrs_id" class="form-control" readonly="readonly" value="<?php echo $replaceRecData->rrs_id; ?>">
                                <input type="hidden" name="damage_no" id="damage_no" value="<?php echo $replaceRecData->rrs_id; ?>">
                            </div>
                        </div>
...
<?php } ?>
               ...
               <input type="submit" name="replaceReceiveToSupplier_update_submit" id="replaceReceiveToSupplier_update_submit" class="btn btn-block" style="background-color:#f26522;color:#ffffff;" value="Update" />
                                </div>    
                            </div>
                        </div>
                    </div>
