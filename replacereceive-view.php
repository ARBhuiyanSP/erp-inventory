...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
			...
			<?php
				$sqld = "select * from `inv_damage` where `damage_id`='$damage_id'";
			...
			<div class="card-body" id="printableArea">
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<center><button class="btn btn-block btn-secondary challan">REPLACE RECEIVE</button></center>
