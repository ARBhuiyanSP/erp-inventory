...
<div class="card mb-3">
    <div class="card-header">
        ...
        Partner  wise  Party Accounts Staus Balance report</div>
    <div class="card-body">
...
<center>
    ...
    <?php
						...
						if($_SESSION['logged']['user_type'] !== 'whm'){
							$sql	=	"SELECT * FROM `inv_partybalance` where `partner_id` = '$partner_id' GROUP BY `pb_party_id`";
						}else{
							$sql	=	"SELECT * FROM `inv_partybalance` WHERE `warehouse_id` = $warehouse_id and `partner_id` = '$partner_id' GROUP BY `pb_party_id`";
						}
...
<tr>
							...
							$balance =  $totdebit -$totcredit; echo number_format((float)$balance, 2, '.', ''); //row balance amount debit - credit
