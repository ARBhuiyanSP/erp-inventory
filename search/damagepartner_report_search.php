...
<tbody>
					...
					<?php
						...
						if($_SESSION['logged']['user_type'] !== 'whm'){
							$sql	=	"SELECT * FROM `inv_damaragedetailsale` WHERE `partner_id` = '$partner_id' and `ds_date` BETWEEN '$from_date' AND '$to_date'";
						}else{
							$sql	=	"SELECT * FROM `inv_damaragedetailsale` WHERE `partner_id` = '$partner_id' and `warehouse_id` = '$warehouse_id'  `ds_date` BETWEEN '$from_date' AND '$to_date'";
						}
