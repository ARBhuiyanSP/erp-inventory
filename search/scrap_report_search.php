				...
				<table id="" class="table table-bordered table-striped ">
					...
					<?php
						...
						if($_SESSION['logged']['user_type'] !== 'whm'){
							$sql	=	"SELECT * FROM `inv_scrap` WHERE  `ss_date` BETWEEN '$from_date' AND '$to_date'";
						}else{
							$sql	=	"SELECT * FROM `inv_scrap` WHERE `warehouse_id` = '$warehouse_id'  `ss_date` BETWEEN '$from_date' AND '$to_date'";
						}
