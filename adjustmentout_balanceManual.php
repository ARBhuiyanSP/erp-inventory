...
<div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="mbout_qty"  id="mbout_qty" class="form-control">
                            </div>
</div>
...
<div class="col-xs-12">
                  ...
                  <input type="submit" name="adjmanualout_submit" id="submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="Save" />   
                            </div>
</div>
                    </div>
