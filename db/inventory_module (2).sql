...
(363, '01-02-001', '40', '157', 'power plus 2022', 'powerplus', '', 20, NULL, NULL, 0, '3', 100, 0, NULL, NULL, NULL, NULL, NULL, NULL, '');
...
(63, 'RTN-CW001', '2022-03-13', 'PRODUCT RETURN', '2', '10', '', '', ''),
(64, 'RTN-CW002', '2022-03-17', 'return', '2', '10', '', '', '');
...
(2041, 'PA-1', 'SAKIB', '19', '2022-03-09 10:54:03', NULL),
(2042, 'PA-2', 'MUSHFIQ', '19', '2022-03-09 10:54:17', NULL),
(2043, 'PA-3', 'LITON', '19', '2022-03-09 10:54:28', NULL),
(2044, 'PA-4', 'ATIQ', '20', '2022-03-09 10:54:44', NULL),
(2045, 'PA-5', 'TANVEER', '20', '2022-03-09 10:54:55', NULL);
...
--
ALTER TABLE `inv_damagebalance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44746;
...
--
ALTER TABLE `inv_materialbalance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44770;
...
--
ALTER TABLE `inv_scrap`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7632;

--
-- AUTO_INCREMENT for table `inv_scrapdetail`
--
ALTER TABLE `inv_scrapdetail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34008;
