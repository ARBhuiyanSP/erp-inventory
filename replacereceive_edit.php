...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    ...
    $data               = getReplaceRecDataDetailsById($edit_id); // this function damage_process.php file ar vitor
...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Replace Receive Edit</li>
    </ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i>
            Replace Receive Edit</div>
        <div class="card-body">
                ...
                <form action="" method="post" name="add_damage" id="damage_entry_form" onsubmit="showFormIsProcessing('damage_entry_form');">
                    <div class="row" id="div1" style="">
                        <div class="col-xs-2">
                            <div class="form-group">
                                <label> Date</label>
                                <input type="text" autocomplete="off" name="damage_date" id="damage_date" class="form-control datepicker" value="<?php echo date('Y-m-d', strtotime($replaceRecData->damage_date)); ?>">
					   ...
					   <div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="damage_id" id="damage_id" class="form-control" readonly="readonly" value="<?php echo $replaceRecData->damage_id; ?>">
                                <input type="hidden" name="damage_no" id="damage_no" value="<?php echo $replaceRecData->damage_id; ?>">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="partner_id" name="partner_id" onchange="getPartyByPartner(this.value);" required >
                                    ...
                                    ?>
                                            ...
                                            <option value="<?php echo $data['id']; ?>" <?php if (isset($replaceRecData->partner_id) && $replaceRecData->partner_id == $data['id']) {
                                                                                            echo 'selected';
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="main_sub_item_id" name="partyname" onchange="getItemCodeByParam(this.value, 'party', 'party_id', 'party_id');">
                                    ...
                                    ?>
                                            ...
                                            <option value="<?php echo $data['id']; ?>" <?php if (isset($replaceRecData->party_id) && $replaceRecData->party_id == $data['party_id']) {
                                                                                            echo 'selected';
                        ...
                        <div class="col-xs-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="party_id" id="party_id" class="form-control"  value="<?php echo (isset($replaceRecData) && !empty($replaceRecData) ? $replaceRecData->party_id : ''); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <div class="modal-footer">
                                    <input type="submit" name="damage_update_submit" id="damage_update_submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="UPDATE" />
                                </div>    
                            </div>
                        </div>
                    </div>
