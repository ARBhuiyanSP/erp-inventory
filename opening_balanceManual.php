...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
           <a href="partneraccountsreport.php">Individual Material OP Stock Entry</a>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i> Individual Material OP Stock Entry
		</div>
        <div class="card-body">
...
<div class="col-xs-1">
                            <div class="form-group">
								...
								<?php
                                   ...
                                   ?>
           <input type="text" name="op_date" id="trop_dateanid" value="<?php echo $op_date; ?>" class="form-control" readonly="readonly">
                            </div>
</div>
...
<div class="col-xs-1">
                            <div class="form-group">
                                <b><label>OP STOCK</label></b>
                                <input type="text" name="op_balance_qty"  id="op_balance_qty" class="form-control">
                            </div>
</div>
...
<div class="col-xs-1">
                            <div class="form-group">
                                <b><label>RATE</label></b>
                                <input type="text" name="op_rate"  id="op_rate" class="form-control">
                            </div>
</div>
...
<div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="op_balance_val"  id="op_balance_val" class="form-control">
                            </div>
</div>
...
<div class="col-xs-12">
                  ...
                  <input type="submit" name="opmanual_submit" id="submit" class="btn btn-block" style="background-color:#007BFF;color:#ffffff;" value="Save" />   
                            </div>
</div>
                    </div>
